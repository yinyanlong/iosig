...
python $IOSIG_HOME/src/analysis/sig.py -m $IOSIG_HOME/src/analysis/format.properties -d ./
...
#    python $IOSIG_HOME/src/analysis/sig.py -m $IOSIG_HOME/src/analysis/format.properties -f $tracefile
    ...
    convert -trim access_hole.png ${tracefile}.access_hole.png
    rm -f access_hole.png
    cd ..
done
